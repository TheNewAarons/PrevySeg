                            ...
                            <div className="card shadow-sm h-100">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <p className="mt-1">
                                            {course.estado === 'por_empezar' && <span className="badge bg-info">Por Empezar</span>}
                                            {course.estado === 'en_curso' && <span className="badge bg-success">En Curso</span>}
                                            {course.estado === 'finalizado' && <span className="badge bg-secondary">Finalizado</span>}
                                            {!course.estado && <span className="badge bg-secondary">Desconocido</span>}
                                        </p>
                                    </div>
                                    <div className="mb-3">
                            ...
                            <div className="card shadow-sm h-100">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <p className="mt-1">{course.hora_inicio || '—'}</p>
                                    </div>
                                    <div className="mb-3">
                                        <strong>Hora de Fin:</strong>
                                        <p className="mt-1">{course.hora_fin || '—'}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="card shadow-sm h-100">
                                ...
                                <div className="card-body">
                                    <div className="mb-3">
                                        ...
                                        <p className="mt-1">{course.documentos_requeridos || 'No se especificaron documentos requeridos.'}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
