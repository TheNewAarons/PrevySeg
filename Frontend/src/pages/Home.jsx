...
function Home() {
    ...
    // Debug: ver cambios en user
    useEffect(() => {
        console.log('Home - Usuario cambió:', user);
    }, [user]);

    // Función para ir al dashboard según el rol
    const handleGoToDashboard = () => {
        console.log('Botón clickeado, user:', user); // Debug
        ...
        const rol = user.rol_nombre || user.rol;
        console.log('Rol detectado:', rol); // Debug
        
        const rolLower = rol?.toLowerCase();
        console.log('Rol en minúsculas:', rolLower); // Debug
        
        let path = '/cliente/dashboard';
            ...
            <header className="header">
                <div className="container">
                    <div className="nav">
                        ...
                        {/*mostrar botones según si está autenticado*/}
                        {user ? (
                            //si está logueado
